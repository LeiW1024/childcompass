...
export const listingRepo = {
  ...
  findPublished: (opts?: {
    ...
    prisma.listing.findMany({
      ...
      select: {
        id: true, title: true, description: true, descriptionDe: true,
        category: true, ageMinMonths: true, ageMaxMonths: true,
        price: true, pricePer: true, address: true, city: true,
        scheduleNotes: true, spotsTotal: true, imageUrl: true,
        latitude: true, longitude: true, maxParticipants: true,
        datePeriods: true, availableTimes: true,
        providerProfile: { select: { businessName: true, logoUrl: true, city: true, address: true, description: true, phone: true, website: true, isClaimed: true } },
      },
